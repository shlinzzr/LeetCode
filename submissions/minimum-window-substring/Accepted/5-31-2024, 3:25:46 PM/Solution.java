...
class Solution {
    public String minWindow(String s, String t) {
        ...
        //optimize :
        // 1. 只用了一個map_t, 跟map_t無關的直接跳過
        // 2. 用了一個counter來記錄current string length, 當長度==t時才判斷
        //    2.a 如何"精準"的紀錄counter 就需要再推理一下
        // 3. 省略substring效能, 用st+wordLen代替
        ...
        return min>len_s ? "" : s.substring(left, left+min);
    }
