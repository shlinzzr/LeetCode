...
Output: ["eat","oath"]
    ...
    */
    ...
    public List<String> findWords(char[][] board, String[] words) {
        ...
        for(int i=0; i<h; i++){
            for(int j=0; j<w; j++){
                ...
                seen[i][j]=true;
                TrieNode curr = root;
                dfs(board, i, j, seen, res, curr.arr[ch-'a']);
            }
        }
        return res;
    }
    ...
    private void dfs(char[][] board, int i, int j, boolean[][] seen, List<String> res, TrieNode curr){
        ...
        for(int[] d: dirs){
            ...
            seen[r][c] =true;
            dfs(board, r, c, seen, res, curr.arr[ch-'a']);
            seen[r][c] =false;
        }
    }
