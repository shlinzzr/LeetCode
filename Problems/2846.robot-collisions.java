...
class Solution {
    public List<Integer> survivedRobotsHealths(int[] positions, int[] healths, String directions) {
        ...
        for(int i=0; i<list.size(); i++){
            ...
            //  System.out.println("i="+i + " cur.pos=" +  cur.pos + " cur.heal=" +  cur.heal + " cur.isright=" +  cur.isRight + " " + (st.isEmpty()? "" : st.peek().isRight));
            ...
            if(cur.isRight){
                ...
                // System.out.println(cur.idx + " " + (st.isEmpty()? "st empty" : st.peek().isRight));
